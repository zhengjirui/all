...
import com.lechuang.shengxinyoupin.presenter.net.converter.StringConverFactory;
import com.lechuang.shengxinyoupin.presenter.net.converter.StringGsonConverFactory;
...
public class Netword {
    ...
    private Context context = AbsApplication.getInstance();
