...
public class MyOrderActivity extends AppCompatActivity implements OnItemClick {
    ...
    private void getData() {
        ...
        Netword.getInstance().getApi(OwnApi.class)
                .orderDetails(type, page, LocalSession.get(this).getSafeToken())
                ...
                .subscribe(new ResultBack<OrderBean>(mContext) {
                    ...
                    public void successed(OrderBean result) {
                        ...
                        if (1 == page) {
                            ...
                            if (mAdapter == null) {
                                mAdapter = new CommonRecyclerAdapter(mContext, R.layout.item_order_details, items) {
                                    @Override
                                ...
                                mAdapter.setOnItemClick(MyOrderActivity.this);
                            }
                        } else {
