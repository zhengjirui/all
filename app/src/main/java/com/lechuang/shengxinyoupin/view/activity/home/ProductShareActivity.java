...
import com.lechuang.shengxinyoupin.model.bean.ShareImageBean;
import com.lechuang.shengxinyoupin.model.bean.TaobaoUrlBean;
...
import com.lechuang.shengxinyoupin.utils.QRCodeUtils;
import com.lechuang.shengxinyoupin.utils.Utils;
import com.lechuang.shengxinyoupin.view.defineView.SpannelTextViewShareProduct;
import com.lechuang.shengxinyoupin.view.dialog.ShareDialog;
...
//    private String mLocalUrl;
    ...
    private void createBitmap(final String hostUrl) {
        ...
        for (int i = 1; i < list.size(); i++) {
            ...
            //获取图片真正的宽高
            Glide.with(AbsApplication.getInstance())
                    .load(s)
