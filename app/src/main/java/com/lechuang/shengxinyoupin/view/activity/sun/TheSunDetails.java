package com.lechuang.shengxinyoupin.view.activity.sun;
...
import com.lechuang.shengxinyoupin.model.ShareModel;
import com.lechuang.shengxinyoupin.model.bean.SunDetailBean;
import com.lechuang.shengxinyoupin.model.bean.SunDetailListBean;
...
import com.lechuang.shengxinyoupin.presenter.net.netApi.TheSunApi;
import com.lechuang.shengxinyoupin.presenter.net.netApi.TipoffShowApi;
...
import com.lechuang.shengxinyoupin.view.activity.tipoff.TipOffCommentDetailsActivity;
import com.lechuang.shengxinyoupin.view.defineView.MListView;
...
import static com.lechuang.shengxinyoupin.base.Constants.listInfo;
        ...
        Netword.getInstance().getApi(TheSunApi.class)
                ...
                .subscribe(new ResultBack<SunDetailBean>(this) {
                    ...
                    public void successed(SunDetailBean result) {
                        ...
                        Glide.with(AbsApplication.getInstance()).load(baskOrder.photo)
