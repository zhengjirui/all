...
import com.lechuang.shengxinyoupin.view.defineView.SquareImageView;
...
public class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.MyViewHolder> {
    ...
    public HomeListAdapter(List<ProductListBean.ProductBean> productList, Context context, int code) {
        data = productList;
        mContext = context;
        isAgencyStatus = code;
    }
    ...
    public void onBindViewHolder(HomeListAdapter.MyViewHolder holder, int position) {
        try {
            ProductListBean.ProductBean bean = data.get(position);
            //商品图
