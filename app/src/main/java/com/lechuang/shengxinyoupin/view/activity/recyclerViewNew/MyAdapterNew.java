package com.lechuang.shengxinyoupin.view.activity.recyclerViewNew;
...
public class MyAdapterNew extends RecyclerView.Adapter {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(String img, String title, String price, String oldPrice, int shopType) {
            ...
            Glide.with(AbsApplication.getInstance()).load(img).placeholder(view.getResources().getDrawable(R.drawable.loading_square)).into(this.img);
        }
