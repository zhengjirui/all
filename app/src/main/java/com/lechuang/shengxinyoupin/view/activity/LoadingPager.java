 ...
 */
    private void initCommonVeiw(){
        mBlankView=View.inflate(AbsApplication.getInstance(), R.layout.activity_blank,null);
        mErrorView=View.inflate(AbsApplication.getInstance(), R.layout.activity_error,null);
