...
import com.lechuang.shengxinyoupin.model.bean.SignBean;
...
public class SigneActivity extends Activity {
    ...
    private String[] days = {"第1天", "第2天", "第3天", "第4天", "第5天", "第6天", "第7天"};
    ...
    class SingeAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                mt.iv_round = (TextView) convertView.findViewById(R.id.iv_round);
            ...
            if (index >= position) {
                mt.tv_score.setTextColor(getResources().getColor(R.color.c_ff0000));
                mt.iv_round.setText("+" + (listBean.signStartIntegral + listBean.rewardIntegral));
                mt.iv_round.setBackgroundResource(images[0]);
                ...
                mt.tv_days.setText(days[position]);
                mt.iv_round.setBackgroundResource(images[1]);
            }
