package com.lechuang.shengxinyoupin.mine.adapter;
...
import com.lechuang.shengxinyoupin.base.MyApplication;
import com.lechuang.shengxinyoupin.view.defineView.RoundedImageView;
import com.lechuang.shengxinyoupin.view.defineView.SpannelTextView;
import com.lechuang.shengxinyoupin.view.defineView.SpannelTextViewGrid;
...
public class ViewHolderRecycler extends RecyclerView.ViewHolder {
    ...
    public ViewHolderRecycler displayImage(int viewId, String url, int defaultView) {
        ImageView mImageView = getView(viewId);
        return displayImage(mImageView, url, defaultView);
    }

    public ViewHolderRecycler displayImage(ImageView view, String url, int defaultView) {
        Glide.with(AbsApplication.getInstance()).load(url).placeholder(defaultView).into(view);
        return this;
    }
