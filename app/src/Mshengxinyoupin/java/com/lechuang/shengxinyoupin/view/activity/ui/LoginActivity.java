...
public class LoginActivity extends AppCompatActivity {
    ...
    ClearEditText et_phonenum;   //手机号
    @BindView(R.id.et_pwd)
    ClearEditText et_pwd;        //密码
    @BindView(R.id.tv_forget_mima)
    TextView tv_forget_mima;  //忘记密码
    @BindView(R.id.btn_login)
    TextView btnLogin;       //确定
    @BindView(R.id.tv_taobao)
    TextView tvTaobao;       //淘宝
    @BindView(R.id.iv_back)
    ImageView ivBack;
    @BindView(R.id.ll_sangfang)
    LinearLayout ll_sanfang;     //三方登录
    ...
    @OnClick({R.id.tv_forget_mima, R.id.btn_login, R.id.tv_taobao, R.id.iv_back, R.id.ll_sangfang, R.id.iv_yanjing, R.id.tv_register,R.id.tip})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_forget_mima://找回密码
