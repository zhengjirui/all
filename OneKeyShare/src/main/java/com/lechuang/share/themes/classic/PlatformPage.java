...
import com.lechuang.share.OnekeySharePage;
import com.lechuang.share.OnekeyShareThemeImpl;
...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		LinearLayout.LayoutParams	lpte = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
//		lpte.leftMargin = ScreenUtils.px2dp(activity,60);
//		lpte.rightMargin = ScreenUtils.px2dp(activity,60);
//		lpte.topMargin = ScreenUtils.px2dp(activity,60);
//		lpte.bottomMargin = ScreenUtils.px2dp(activity,60);
		lpte.gravity = Gravity.CENTER;
		Button btnCancel = new Button(activity);
		btnCancel.setText("取消");
		btnCancel.setTextSize(16);
		btnCancel.setTextColor(Color.parseColor("#5D5D5D"));
		btnCancel.setBackgroundColor((Color.parseColor("#F9F9F9")));
		...
		llPanel.addView(btnCancel,lpte);
